                    ...
                    <div class="card form-card shadow">
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <h3 class="mb-0">{{ __('Épiceries') }}</h3>
                                </div>
                                <div class="col-4 text-right">
                                    <a href="{{url('GroceryShop/create')}}" class="btn btn-sm btn-primary">{{ __('Ajouter épiceries') }}</a>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <td>
                                                    <a href="{{url('Shop/'.$shop->id.'/edit')}}" class="table-action" data-toggle="tooltip" data-original-title="Edit product">
                                                        <i class="fas fa-user-edit"></i>
                                                            ...
                                                            <a class="dropdown-item" href="{{url('GroceryShop/'.$shop->name)}}" class="table-action" data-toggle="tooltip" data-original-title="View">
                                                             <i class="fas fa-user-edit"></i>
                                                            </a>
