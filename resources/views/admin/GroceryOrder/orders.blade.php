@extends('admin.master', ['title' => __('commandes')])

@section('content')
    @include('admin.layout.topHeader', [
        'title' => __('Commandes d\'épicerie ') ,
        'class' => 'col-lg-7'
    ]) 
                        ...
                        @if(count($orders)>0)
                            <table class="table data-table align-items-center table-flush" >
                                <thead class="thead-light">
                                    <tr>
                                        <th scope="col">{{ __('#') }}</th>
                                        <th scope="col">{{ __('ID_commande') }}</th>
                                        <th scope="col">{{ __('clients') }}</th>
                                        <th scope="col">{{ __('payment') }}</th>
                                        <th scope="col">{{ __('date') }}</th>
                                        <th scope="col">{{ __('Payment GateWay') }}</th>
                                        <th scope="col">{{ __('Statut') }}</th>
                                        <th scope="col">{{ __('livreur') }}</th>
                                        <th scope="col">{{ __('Statut de paiement') }}</th>
