                ...
                <form class="mt-4 mb-3 d-md-none">
                    ...
                    <div class="input-group input-group-rounded input-group-merge">
                        <input type="search" class="form-control form-control-rounded form-control-prepended"
                            placeholder="{{ __('Rechercher') }}" aria-label="Search">
                ...
                <ul class="navbar-nav">
                            ...
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a class="nav-link {{ request()->is('Customer')  ? 'active-tab' : ''}}" href="{{url('Customer')}}">
                                        <i class="fas fa-users" style="color:#8abf4d;"></i> {{ __('Utilisateurs') }}
                                    </a>
                                </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('customerReport') || request()->is('groceryRevenueReport') ? 'active' : ''}}" href="#report-expand" data-toggle="collapse" role="button"
                            ...
                            <span class="nav-link-text">{{ __('Rapports') }}</span>
                        </a>
                            ...
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a class="nav-link {{ request()->is('customerReport')  ? 'active-tab' : ''}}" href="{{url('customerReport')}}">
                                            <i class="ni ni-paper-diploma" style="color:#ff9200;"></i> {{ __('Rapport client') }}
                                        </a>
                                    </li>
                                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('NotificationTemplate')  ? 'active' : ''}}" href="{{url('NotificationTemplate')}}">
                            <i class="fas fa-bell" style="color: #f53d55;"></i> {{ __('paramètre de notification') }}
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('user-request')  ? 'active' : ''}}" href="{{url('user-request')}}">
                            <i class="fa fa-paper-plane text-pink "></i> {{ __('Demande de l\'utilisateur') }}
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('OwnerSetting')  ? 'active' : ''}}" href="{{url('OwnerSetting')}}">
                            <i class="ni ni-settings-gear-65 text-info"></i> {{ __('Paramètre') }}
                        </a>
                    </li>
                    @endif
                </ul>
