@extends('admin.master', ['title' => __('TABLEAU DE BORD')])
                ...
                <div class="col-xl-3 col-lg-6">
                    <div class="card card-stats mb-4 mb-xl-0">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h5 class="card-title text-uppercase text-muted">{{ __('MAGASINS')}}</h5>
                ...
                <div class="col-xl-3 col-lg-6">
                    <div class="card card-stats mb-4 mb-xl-0">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h5 class="card-title text-uppercase text-muted">{{ __('NOUVEAUX UTILISATEURS')}}</h5>
                ...
                <div class="col-xl-3 col-lg-6">
                    <div class="card card-stats mb-4 mb-xl-0">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h5 class="card-title text-uppercase text-muted">{{ __('ventes')}}</h5>
                ...
                <div class="col-xl-3 col-lg-6">
                    <div class="card card-stats mb-4 mb-xl-0">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h5 class="card-title text-uppercase text-muted">{{ __('LIVREURS')}}</h5>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Commandes d\'épicerie ') }}</h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{url('GroceryOrder')}}" class="btn btn-sm btn-primary">{{ __('voir tout') }}</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive" id="grocery-pending-order">
                        ...
                        <div class="empty-state text-center pb-3">
                            ...
                            <p style="font-weight:600;">{{__("Votre liste de collection est vide.....")}}</p>
                        </div>
                        @endif
                    </div>
        ...
        <div class="col-8">
            <div class="card shadow mb-5">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">{{ __('Nos emplacements') }}</h3>
            ...
            <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{url('GroceryCategory')}}" class="btn btn-sm btn-primary">{{ __('voir tout') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
        ...
        <div class="col-8">
            <div class="card shadow mb-5">
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <h3 class="mb-0">{{ __('Clients satisfaits') }}</h3>
        </div>
        <div class="col-4 text-right">
            <a href="{{url('viewUsers')}}" class="btn btn-sm btn-primary">{{ __('voir tout') }}</a>
        </div>
    </div>
</div>
...
<div class="card shadow mb-4">
    <div class="card-header border-0">
        <div class="row align-items-center">
            <div class="col-8">
                <h3 class="mb-0">{{ __('Nos boutiques') }}</h3>
            </div>
            <div class="col-4 text-right">
                <a href="{{url('GroceryShop')}}" class="btn btn-sm btn-primary">{{ __('voir tout') }}</a>
            </div>
        </div>
    </div>
        ...
        <table class="table align-items-center table-flush">
            <thead class="thead-light">
                <tr>
                    ...
                    <th scope="col">{{ __('Emplacement') }}</th>
                    <th scope="col">{{ __('Rayon') }}</th>                  
                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                <a class="dropdown-item" href="{{url('GroceryShop/'.$shop->name)}}">{{ __('voir') }}</a>
                                <a class="dropdown-item" href="{{url('GroceryShop/'.$shop->id.'/edit')}}">{{ __('Modifier') }}</a>
...
<div class="col-4">
    ...
    <div class="card shadow">
        <div class="card-header border-0">
            <div class="row align-items-center">
                <div class="col-8">
                    <h3 class="mb-0">{{ __('Nos articles') }}</h3>
                </div>
                <div class="col-4 text-right">
                    <a href="{{url('GroceryItem')}}" class="btn btn-sm btn-primary">{{ __('voir tout') }}</a>
                </div>
            </div>
        </div>
        <div class="card-body">
