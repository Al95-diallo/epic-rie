                        ...
                        <div class="product-top-dt">
                            ...
                            <div class="product-sort">
                                <div class="ui selection dropdown vchrt-dropdown">
                                    ...
                                    <div class="text">{{__('Nouvelle arrivée')}}</div>
                                    <div class="menu">
                                        <div class="item" data-value="new">{{__('Nouvelle arrivée')}}</div>
                                        <div class="item" data-value="price-asc"> {{__('Prix ​​croissant')}} </div>
                                        <div class="item" data-value="price-desc"> {{__('Prix ​​- Élevé à bas')}} </div>
                                        <div class="item" data-value="alphabetical"> {{__('Alphabétique')}} </div>
                                        <div class="item" data-value="off-desc"> {{__('Économie - Élevé à faible')}} </div>
                                        <div class="item" data-value="off-asc"> {{__('Économie - faible à élevée')}} </div>
                                    </div>
                                </div>
                            </div>
                            <div class="product-sort">
