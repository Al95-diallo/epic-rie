				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<div class="main-title-tt">
								<div class="main-title-left">
									<span> {{__('Pour toi')}} </span>
									<h2> {{__('Nouveaux produits ajoutés')}} </h2>
								</div>
								<a href="{{url('/featured-products')}}" class="see-more-btn"> {{__('voir tout')}} </a>
							</div>
						</div>
						<div class="col-md-12">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="main-title-tt">
								<div class="main-title-left">
									<span>{{__('pour toi')}}</span>
									<h2>{{__('Légumes et fruits frais')}}</h2>
								</div>
								<a href="{{url('/all-products')}}" class="see-more-btn">{{__('voir tout')}}</a>
							</div>
						</div>
						<div class="col-md-12">
							<div class="owl-carousel featured-slider owl-theme">
