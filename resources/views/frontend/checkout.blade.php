                        ...
                        <div id="checkout_wizard" class="checkout accordion left-chck145">
                            <div class="checkout-step">
                                <div class="checkout-card" id="headingOne">
                                    ...
                                    <h4 class="checkout-step-title"> 
                                        <button class="wizard-btn" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne"> {{__('Avez vous un code de réduction?')}} </button>
                                    </h4>
                                </div>
                                <div id="collapseOne" class="collapse in" data-parent="#checkout_wizard">
                                    <div class="checkout-step-body">
                                        <p>{{__('Entrez un code promotionnel valide et obtenez des rabais incroyables')}}</p>
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <div class="checkout-login">
                                                    <div class="login-phone">
                                                        <input type="text" class="form-control" value="{{$coupon_code}}" placeholder="Entrer le Code" name="promocode" id="input-promocode">
                                                    </div>
                                                    <a class="chck-btn hover-btn code-apply-btn"> {{__('Appliquer')}} </a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="checkout-step">
                                <div class="checkout-card" id="headingTwo">
                                    ...
                                    <h4 class="checkout-step-title">
                                        <button class="wizard-btn collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"> {{__('Adresse de livraison')}}</button>
                                    </h4>
                                </div>
                                        ...
                                        <div class="checout-address-step">
                                            <div class="row">
                                                <div class="col-lg-12">	
                                                        ...
                                                        <div class="address-fieldset">
                                                            <div class="row">
                                                                <div class="col-lg-12 col-md-12">
                                                                    <div class="form-group">
                                                                        <label class="control-label"> {{__('Appartement / Maison / Bureau N°.')}}* </label>
                                                                ...
                                                                <div class="col-lg-12 col-md-12">
                                                                    <div class="form-group">
                                                                        <label class="control-label"> {{__('Rue / Société / Nom du bureau*')}}*</label>
                                                                ...
                                                                <div class="col-lg-6 col-md-12">
                                                                    <div class="form-group">
                                                                        <label class="control-label">{{__('ville')}}*</label>
                                                    ...
                                                    @else
                                                        <a href="#" class="add-address hover-btn" data-toggle="modal" data-target="#address_model"> {{__('Ajouter une nouvelle adresse')}} </a>
                                                    @endif					
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="checkout-step last-step">
                                <div class="checkout-card" id="headingThree"> 
                                    ...
                                    <h4 class="checkout-step-title">
                                        <button class="wizard-btn collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree"> {{__('Paiement')}} </button>
                                    </h4>
                                </div>
                                        ...
                                        <div class="payment_method-checkout">	
                                            <div class="row">	
                                                <div class="col-md-12">
                                                    ...
                                                    <button type="submit" id="form_submit" class="next-btn16 hover-btn"> {{__('passer la commande')}} </button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-4 col-md-5">
                        <div class="pdpt-bg mt-0">
                            <div class="pdpt-title">
                                <h4> {{__('Récapitulatif de la commande')}} </h4>
                            </div>
                            ...
                            <div class="payment-secure">
                                <i class="uil uil-padlock"></i> {{__('Paiement sécurisé')}}
                            </div>
                        </div>
                        <a href="#" class="promo-link45"> {{__(' Avez vous un code de réduction?')}} </a>
                        <div class="checkout-safety-alerts">
                            <p><i class="uil uil-sync"></i> {{__('Garantie de remplacement à 100 %')}} </p>
                            <p><i class="uil uil-check-square"></i> {{__('Produits 100% authentiques')}} </p>
                            <p><i class="uil uil-shield-check"></i> {{__('Paiements sécurisés')}} </p>
                        </div>
                    </div>
                </div>
            </div>
