				...
				<div class="row">
					<div class="col-lg-3 col-md-6 col-sm-6">
						<div class="second-row-item">
							...
							<ul>
								...
								@endforeach
								<li><a href="{{url('/all-categories')}}"> {{__('toutes les catégories')}} </a></li>
							</ul>
						</div>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-6">
						<div class="second-row-item">
							...
							<ul>
								<li><a href="{{url('/featured-products')}}"> {{__('Produits populaires')}} </a></li>
								<li><a href="{{url('/offers')}}"> {{__('Offres')}} </a></li>
								<li><a href="{{url('/faq')}}">{{__('Faq')}}</a></li>
								<li><a href="{{url('/contact-us')}}"> {{__('Nous contacter')}} </a></li>
							</ul>
						</div>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-6">
						<div class="second-row-item">
							<h4> {{__('Meilleures villes')}} </h4>
							<ul>
					...
					<div class="col-lg-3 col-md-6 col-sm-6">
						<div class="second-row-item-app">
							<h4> {{__('Télécharger l\'application')}} </h4>
							<ul>
					...
					<div class="col-md-12">
						<div class="footer-bottom-links">
							<ul>
								...
								<li><a href="#"> {{__('Conditions générales')}} </a></li>
								<li><a href="#"> {{__('Politique de remboursement et de retour')}} </a></li>
							</ul>
						</div>
