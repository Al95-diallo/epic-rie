                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-title-tab">
                                    <h4><i class="uil uil-apps"></i> {{__('Aperçu')}} </h4>
                                </div>
                                <div class="welcome-text">
                                    <h2> {{__('Salut')}}! {{Auth::user()->name}}</h2>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12">
                                <div class="pdpt-bg">
                                    <div class="pdpt-title">
                                        <h4>{{__('Mes commandes')}}</h4>
                                    </div>
                                    @if ($order != null)
                                        <div class="ddsh-body">
                                            ...
                                            <ul class="order-list-145">
                                                ...
                                                <li>
                                                    <div class="smll-history">
                                                        <div class="order-title">{{count($order->orderItem)}} {{__('produit')}} <span data-inverted="" data-tooltip="{{ implode(', ', $ar)}}" data-position="top center">?</span></div>
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="how-order-steps">
                                            ...
                                            <h4>{{__('Aucune commande trouvée')}}</h4>
                                        </div>
                                    </div>
                                    @endif
                                    <a href="{{url('/profile/orders')}}" class="more-link14">{{__("tous les commandes")}} <i class="uil uil-angle-double-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
