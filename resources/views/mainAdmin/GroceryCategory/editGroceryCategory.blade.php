@extends('admin.master', ['title' => __('Modifier la catégorie d\'épicerie')])

@section('content')
    @include('admin.layout.topHeader', [
        'title' => __('Modifier la catégorie d\'épicerie') ,
                        ...
                        <div class="card form-card bg-secondary shadow">
                            <div class="card-header bg-white border-0">
                                <div class="row align-items-center">
                                    <div class="col-8">
                                        <h3 class="mb-0">{{ __('Modifier la catégorie d\'épicerie') }}</h3>
                                    </div>
                                    ...
                                    <div class="pl-lg-4">
                                            ...
                                            <div class="col-10">
                                                <div class="form-group{{ $errors->has('image') ? ' has-danger' : '' }}">
                                                    ...
                                                    <div class="custom-file">
                                                        ...
                                                        <label class="custom-file-label" for="image">Selectionnez l'image</label>
                                                    </div>
                                                    @if ($errors->has('image'))
                                                        <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="form-group{{ $errors->has('status') ? ' has-danger' : '' }}">
                                            ...
                                            <Select name="status" id="input-status" class="form-control form-control-alternative{{ $errors->has('status') ? ' is-invalid' : '' }}"  required>
                                                ...
                                                <option value="0" {{ $data->status=="0" ? 'Selected' : ''}}>disponible</option>
                                                <option value="1" {{ $data->status=="1" ? 'Selected' : ''}}>Non disponible</option>
                                            </select>
