@extends('admin.master', ['title' => __('Gestion ed\'mplacement')])
                    ...
                    <div class="card form-card shadow">
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <h3 class="mb-0">{{ __('Emplacement') }}</h3>
                                </div>
                                <div class="col-4 text-right">
                                    <a href="{{url('Location/create')}}" class="btn btn-sm btn-primary">{{ __('Ajouter un nouvel emplacement') }}</a>
                                </div>
                            </div>
                        </div>
                            ...
                            @if(count($locations)>0) 
                                <table class="table align-items-center table-flush">
                                    <thead class="thead-light">
                                        <tr>
                                            <th scope="col">{{ __('#') }}</th>
                                            <th scope="col">{{ __('Nom_emplacement') }}</th>
                                                ...
                                                <td>                            
                                                    ...
                                                    {{-- <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                            <a class="dropdown-item" href="{{url('Location/'.$location->id.'/edit')}}">{{ __('modifier') }}</a>
                                                            <a class="dropdown-item" onclick="deleteData('Location','{{$location->id}}');" href="#">{{ __('supprimer') }}</a>
                                                        </div>
                                                    </div> --}}
                                                </td>
                                            </tr>
