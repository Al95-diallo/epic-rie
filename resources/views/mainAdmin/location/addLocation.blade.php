@extends('admin.master', ['title' => __('Ajouter un emplacement')])

@section('content')
    @include('admin.layout.topHeader', [
        'title' => __('Ajouter un emplacement') ,
        'headerData' => __('emplacement') ,
        'url' => 'Location' ,
        'class' => 'col-lg-7'
    ]) 
                        ...
                        <div class="card form-card bg-secondary shadow">
                            <div class="card-header bg-white border-0">
                                <div class="row align-items-center">
                                    <div class="col-8">
                                        <h3 class="mb-0">{{ __('Ajouter un emplacement') }}</h3>
                                    </div>
                                    <div class="col-4 text-right">
                                        <a href="{{ url('Location') }}" class="btn btn-sm btn-primary">{{ __('Retour à la liste') }}</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <form method="post" action="{{url('Location')}}" autocomplete="off" >
                                    ...
                                    <h6 class="heading-small text-muted mb-4">{{ __('DÉTAIL DE L\'EMPLACEMENT') }}</h6>
                                    <div class="pl-lg-4">
                                        <div class="row">
                                            <div class="col-6">
                                        ...
                                        <div class="form-group{{ $errors->has('address') ? ' has-danger' : '' }}">
                                            <label class="form-control-label" for="input-address">{{ __('Adresse') }}</label>
                                        ...
                                        <div class="form-group{{ $errors->has('radius') ? ' has-danger' : '' }}">
                                            <label class="form-control-label" for="input-radius">{{ __('Rayon') }}</label>
                                        ...
                                        <div class="form-group{{ $errors->has('popular') ? ' has-danger' : '' }}">                                            
                                                <div class="row">
                                                    <div class="col-2"> <label class="form-control-label">{{ __('est populaire') }}?</label></div>
                                                    <div class="col-10">
