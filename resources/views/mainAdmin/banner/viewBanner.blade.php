@extends('admin.master', ['title' => __('gestion de Bannière ')])
                ...
                <div class="card form-card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Bannière ') }}</h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{url('Banner/create')}}" class="btn btn-sm btn-primary">{{ __('Ajouter une nouvelle bannière  ') }}</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table align-items-center table-flush">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th scope="col">{{ __('Titre 1') }}</th>
                                        <th scope="col">{{ __('titre 2') }}</th>
                                            ...
                                            <td>                            
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                        <a class="dropdown-item" href="{{url('Banner/'.$item->id.'/edit')}}">{{ __('modifier') }}</a>
                                                        <a class="dropdown-item " onclick="deleteData('Banner','{{$item->id}}');" href="#">{{ __('supprimer') }}</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
