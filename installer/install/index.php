    ...
    <div class="container">
      <div class="section">
        <div class="column is-6 is-offset-3">
          <center>
            <h1 class="title" style="padding-top: 20px">Gambo Installation | <?php echo str_rot13('<n uers="uggcf://AhyyWhatyr.pbz">Ahyyrq Ol AhyyWhatyr.pbz</n>');?> </h1><br>
          </center>
          <div class="box">
            <?php
switch ($step) {
...
break;
  ...
  <div class="content has-text-centered">
    <p>© <?php echo date('Y'); ?> Copyright Gambo by <a  target="_blank"  href="http://saasmonks.in/">SaasMonks</a> | <?php echo str_rot13('<n uers="uggcf://AhyyWhatyr.pbz">Ahyyrq Ol AhyyWhatyr.pbz</n>');?> </p><br>
  </div>
</body> 
